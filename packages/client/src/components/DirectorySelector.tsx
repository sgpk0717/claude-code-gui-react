            ...
            {sortedPaths.map((item) => (
              ...
              >
                <button
                  ...
                  className={`w-full text-left px-3 py-2 pr-10 text-sm rounded border ${
                    item.pinned 
                ...
                <button
                  ...
                  className={`absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded hover:bg-gray-200 transition-opacity ${
